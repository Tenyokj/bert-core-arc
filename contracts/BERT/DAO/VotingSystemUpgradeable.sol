...
/**
 * @title VotingSystem
 * @notice Manages voting rounds for idea selection within the protocol
    ...
    IVotingSystem 
{
   ...
   /* ========== EXTERNAL FUNCTIONS ========== */
     ...
     * @dev Transfers USDC from voter to funding pool as voting weight
     * @param roundId Voting round identifier
     * @param ideaId Idea to vote for
     * @param amount Amount of USDC to commit as votes
